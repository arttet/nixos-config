...
in
{
  config = lib.mkIf cfg.enable {
    ...
    # These units are referenced by generic targets but are not generated by
    # this headless, non-Plymouth profile. Disable the phantom units so they
    # do not appear as not-found entries in systemd diagnostics.
