...
let
  ...
  # VeraCrypt is temporarily disabled to reduce CI build times while the
  # project experiments with binary caching. Re-enable once caching is stable.
...
in
{
  ...
  #
  # NOTE: temporarily disabled alongside the veracrypt package above.
